...
public class adduser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("DOB (Date Of Birth)");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        fff.pack();
        fff.setLocationRelativeTo(null);
        fff.setDefaultCloseOperation(adduser.EXIT_ON_CLOSE);
        this.dispose();
    ...
    // Example method where email validation is used
    public static void processEmail(String email) {
        if (isValidEmail(email)) {
            JOptionPane.showMessageDialog(null, "Email " + email + " Success Insertion.");
            // Perform further processing or actions
        } else {
            JOptionPane.showMessageDialog(null, "Email " + email + " is invalid.");
